...
INSERT INTO `classic_comic` VALUES (1,'devi sati','Mystery','https://example.com/cover.jpg','superb comic, awesome style of writing','episode 1','comics/pdfs/HVU_wQIdk94.pdf',1,1,'2025-06-14 05:26:53.147151',1);
...
CREATE TABLE `comic_page` (
  ...
  PRIMARY KEY (`id`),
  KEY `comic_page_classic_comic_id_dc01bb00_fk_classic_comic_comic_id` (`classic_comic_id`),
  KEY `comic_page_modern_comic_id_6c1872d6_fk_modern_co` (`modern_comic_id`),
  CONSTRAINT `comic_page_classic_comic_id_dc01bb00_fk_classic_comic_comic_id` FOREIGN KEY (`classic_comic_id`) REFERENCES `classic_comic` (`comic_id`),
  CONSTRAINT `comic_page_modern_comic_id_6c1872d6_fk_modern_co` FOREIGN KEY (`modern_comic_id`) REFERENCES `modern_comic` (`motion_comic_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'cms','appuser'),(5,'contenttypes','contenttype'),(6,'sessions','session'),(12,'uploader','classiccomic'),(11,'uploader','comic'),(14,'uploader','comicpage'),(8,'uploader','episode'),(13,'uploader','moderncomic'),(9,'uploader','page'),(10,'uploader','socialdata');
...
INSERT INTO `modern_comic` VALUES (1,'alfa centaury','Fantasy','https://example.com/thumbnail.jpg','superb video file','episode 1','comics/videos/0f4415cd-8553-47df-8b63-db1a90f48e68_PpaobA3.mp4',1,1,'2025-06-14 05:28:27.121467',1);
...
-- Dump completed on 2025-06-14 11:07:13
